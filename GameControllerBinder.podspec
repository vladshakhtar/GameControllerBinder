#
#  Be sure to run `pod spec lint GameControllerBinder.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "vladshakhtar" => "stolyarovs2003@gmail.com" }
  # Or just: spec.author    = "vladshakhtar"
  # spec.authors            = { "vladshakhtar" => "stolyarovs2003@gmail.com" }
  # spec.social_media_url   = "https://twitter.com/vladshakhtar"
...
spec.source       = { :git => "https://github.com/vladshakhtar/GameControllerBinder.git", :tag => "v1.1.1" }
